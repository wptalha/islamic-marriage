...
class us_migration_2_0 extends US_Migration_Translator {
	...
	public function migration_completed_message() {
		...
		$output .= '<p><strong>Congratulations</strong>: Migration to Impreza ' . US_THEMEVERSION . ' is completed! Now please regenerate thumbnails and check your website once again. If you notice some issues, <a href="https://help.us-themes.com/impreza/update20/" target="_blank">follow the manual</a>.</p>';
		$output .= '</div>';
