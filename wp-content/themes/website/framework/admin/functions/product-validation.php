			...
			<div class="us-validation">
				...
				<form class="us-form for_validation" method="post">
					<div class="us-form-row">
						<div class="us-form-row-description">Enter your
							<a href="<?php echo $help_domain ?>/assets/img/find-item-purchase-code.png" target="_blank" title="Click to see how to find your Item Purchase Code">Item
								Purchase Code</a>. This code will be attached to domain name: <span class="domain">example.com</span>
							(you can change this domain name later).
						</div>
					</div>
					<div class="us-form-row">
				...
				<form class="us-form for_validation" method="post">
					<div class="us-form-row">
						<div class="us-form-row-description">The code below will be attached to domain name:
							<span class="domain">example.com</span> (you can change this domain name later).
						</div>
					</div>
					<div class="us-form-row">
					...
					<div class="us-form-row">
						<div class="us-form-row-description">Your Envato user is not yet registered at our
							<a href="<?php echo $help_domain ?>/" target="_blank">Support Portal</a>.<br>To complete
							validation please create Support Portal account by providing your email (your password will
				...
				<form class="us-form for_validation" method="post">
					...
					<div class="us-form-row check_wrong">
						...
						<div class="us-form-row-state">The provided purchase code is already attached to other domain
							name
						</div>
					</div>
					<div class="us-form-row">
						<div class="us-form-row-description">Your purchase allows you to use this theme on one domain
							only. You can change attached domain name at your
							<a href="<?php echo $help_domain ?>/user/myph/licenses/" target="_blank">licenses page</a>
							or you can <a href="#" target="_blank">buy another license</a>.
						</div>
					</div>
					<div class="us-form-row for_submit">
						<input class="button button-primary" type="submit" value="Validate" name="validate">
				...
				<div class="us-form for_validation">
					<div class="us-form-row">
						<div class="us-form-row-success">Your theme is validated successfully. All premium options are
							available to you.
						</div>
					</div>
				</div>
