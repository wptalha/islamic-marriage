...
//			wp_enqueue_style( 'rwmb-plupload-image', RWMB_CSS_URL . 'plupload-image.css', array( 'wp-admin' ), RWMB_VER );
		...
		static function html( $html, $meta, $field )
		{
			...
			$i18n_drop   = apply_filters( 'rwmb_plupload_image_drop_string', 'Drop images here', $field );
			$i18n_or     = apply_filters( 'rwmb_plupload_image_or_string', 'or', $field );
			$i18n_select = apply_filters( 'rwmb_plupload_image_select_string', 'Select Files', $field );
