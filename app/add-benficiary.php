...
?>
	...
	<form action="benficiary-process.php" method="post" name="form1">
...
<option value="Zimbabwe">Zimbabwe</option>
            ...
            <tr> 
				...
				<td><input type="text" name="badd" required></td>
			</tr>
			<tr> 
				<td></td>
				<td><input class="aded" type="submit" name="Submit" value="Add Beneficiary"></td>
			</tr>
		</table>
	</form>
